...
/**
 * Created by skateboard on 16-6-2.
 */
public class StepsRequest extends BaseRequest<String>
{
    private HashMap<String,String> params;

    public StepsRequest(int method, String url, Response.Listener successListener, Response.ErrorListener errorListener)
    {
        super(method, url, successListener, errorListener);
    }

    public StepsRequest(int method, String url, BaseListener listener,HashMap<String,String> params)
    {
